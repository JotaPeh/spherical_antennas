...
ZinP2 = ZCP(freqs, 2, 1) / ratioI + ZCP(freqs, 2, 2)
...
def Gain():
    ...
    parametros += f"Simulacao:\nDiretividade (dB) = {10*np.log10(10**(G_RHCP/10)/0.83165)}\nEficiencia (%) = {83.165}\nGanho (dBi) = {G_RHCP}"
    out_dir = 'Resultados'
    out_file = os.path.join(out_dir, 'CP_2P_Ganho.txt')
